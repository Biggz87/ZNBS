    ...
    ready(data);
				...
				<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>Upload Property Images</div>

								<p style="color: red">(Enter atleast Four first Photos)</p>
							</div>
...
<div class="row">
    ...
    <h3>Thumnail<span style="color: red" > *</span></h3>
...
<div class="control-group span4" >
    <h3>Upload new image<span style="color: red" > *</span></h3>
