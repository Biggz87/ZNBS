...
<select  name="Type" >
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="number"  name="Plot_width" placeholder="Plot length in meters" class="span6 m-wrap"  required />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="number" placeholder="Plot width in meters"  name="Plot_length" class="span6 m-wrap"  required />
