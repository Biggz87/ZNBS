...
$picture='';
  ...
  $SQL3 = "INSERT INTO `Directors`(`Identity`, `Title`, `Firstname`, `LastName`, `picture`, `Role`) VALUES ('','$Title','$first_name','$last_name','$nameofFile','$jobRole')";
  
    $result3= mysqli_query($conn,$SQL3);
   if($result3){
   
  echo '<div class="alert alert-success"> The Director has been added Successfully</div>';
    		
}else {


			
			echo '<div class="alert alert-danger"> The Director has NOT  been added due to some error</div>';
									...
									<div class="control-group">
													...
													<div class="controls">
														...
														<select  name="Role" >
																	...
																	<option value="Mr.">Chairman</option>
