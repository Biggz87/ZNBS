...
$Art_id=$_GET['articleid']; ?><!DOCTYPE html>
...
$documentname=$_FILES['Ducument_upload']['name'];
  include('async_addpic.php');
  
$lengthImage=strlen(trim($document));
...
`At_category`=:category,`At_status`=:status,`Document`=if('$lengthImage'=0,`Document`,:document) WHERE `article_id`=:Art_id";
...
if ($stmt->execute()) {
 ...
 echo "<script>window.location = 'ArticleListSavings.php?statusedit=Yes'</script>";
    		
}else {
$stmt->errorInfo();

			
			 echo "<script>window.location = 'ArticleListSavings.php?statusedit=No'</script>";
								  ...
								  <div class="control-group">
									 ...
									 <div class="control-group">
                                      ...
                                      <div id="editor">
										  ...
										  <textarea id='edit' rows="15" class="span6 wysihtml5 m-wrap" style="margin-top: 5px;" name='content' placeholder="Type some text">
