...
$stmt->bindParam(":propert_id",$propert_id );
   ...
   if($stmt->execute()){
  echo '<div class="alert alert-success"> The Property has been edited Successfully</div>';
...
<Option  value="<?php echo $row2['type']; ?>"><?php echo $row2['type']; ?></option>
											                  ...
											                  while($row= $stmt->fetch()){
																...
																?>
																<option value="<?php echo $row2['category_id']; ?>"> <?php echo $row2['Name']; ?> 
																</option>
																<?php } ?>
									...
									<div class="control-group">
													...
													<div class="controls">
														...
														<textarea class="span6 m-wrap" rows="5" value="" name="Description" required><?php echo $row2['description']; ?></textarea>
