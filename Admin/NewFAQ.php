...
$SQL3 = "INSERT INTO `q_and_a`(`quest_no`, `question`, `answer`) VALUES (:quest_no,:Question,:Answer)";
 
$stmt = $conn->prepare($SQL3);

$stmt->bindParam(":quest_no",$quest_no);
...
$stmt->bindParam(":Answer",$Answer);
 ...
 echo "<script>window.location = 'QandA.php?status=Yes'</script>";
    		
}else {	
			 echo "<script>window.location = 'QandA.php.php?status=No</script>";
								...
								<form action="#" method="POST" enctype="multipart/form-data" class="form-horizontal">
								  ...
								  <div class="control-group">
										...
										<div class="controls">
											...
											<textarea name="Question"  class="span6 wysihtml5 m-wrap"   id="Category" rows="5" ></textarea>
									 ...
									 <div class="control-group">
										...
										<div class="controls">
										<textarea name="Answer"  class="span6 wysihtml5 m-wrap"   id="Category" rows="5" ></textarea>
