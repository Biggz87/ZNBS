...
?>
 ...
 INNER JOIN `at_categories` ON `articles`.`At_category`=`at_categories`.`ID` INNER JOIN `sub_category` ON `sub_category`.`Sub_id`=`articles`.`At_sub_cat`  WHERE `At_sub_cat`='17' ";
            ...
            ?>
										...
										<ul class="dropdown-menu pull-right">
											...
											<li><a href="EditArticle.php?articleid=<?php  echo $row5['article_id']; ?>&page=Vision">Edit Article</a></li>

											<li><a href="DeleteArtlcle.php?decriptid=<?php  echo $row5['article_id']; ?>&page=Vision">Delete Article</a></li>
