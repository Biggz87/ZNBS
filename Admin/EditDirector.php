...
$first_name=$_POST['first_name'];
 ...
 $SQL3 = "UPDATE `directors` SET `Title`='$Title',`Firstname`='$first_name',`LastName`='$last_name',`picture`=if(LENGTH('$nameofFile')=0,`picture`,'$nameofFile'),`Role`='$jobRole' WHERE `Identity`='$direct_id'";
  ...
  echo '<div class="alert alert-success"> The Director has been edited Successfully</div>';
			...
			echo '<div class="alert alert-danger"> The Director has NOT  been edited due to some error</div>';
...
?>  
						<!-- BEGIN SAMPLE FORM PORTLET-->   
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>Edit Director </div>
							...
							<form action="#" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											...
											<input type="text"  name="first_name" value="<?php echo  $row6['Firstname']    ?>" class="span6 m-wrap" required />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text"  name="last_name" value="<?php echo  $row6['LastName']    ?>" class="span6 m-wrap" required />
									...
									<div class="control-group">
													...
													<div class="controls">
														...
														<select  name="Role" >
                                                                    <option value="<?php echo  $row6['Role']    ?>"><?php echo  $row6['Role']    ?></option>
										...
										<a href="Directors.php"><button type="button" class="btn">Back to List</button></a>                            
