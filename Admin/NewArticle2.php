								  ...
								  <div class="control-group">
									 ...
									 <div class="control-group">
                                      ...
                                      <div id="editor">
										  ...
										  <textarea id='edit' style="margin-top: 5px;"  rows="15" class="span6 wysihtml5 m-wrap" name='content' placeholder="Type some text">
									...
									<div class="control-group">
										...
										<label class="control-label">Youtube Video<span class="required">*</span></label>

										<div class="controls">
                                     
   
										  <textarea  style="margin-top: 5px;"  rows="15"  class="span6"  name="youtube" placeholder="Type some text">
