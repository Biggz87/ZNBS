...
$employee_number=$_POST['emp_id'];;

 $SQL3 = "INSERT INTO `employees_tbl`(`emp_id`, `Title`, `first_name`, `last_name`, `date_of_birth`, `email`, `mobile_number`, `whatsapp`, `address1`, `address2`, `city_town`, `genda`, `country`, `date_joined`, `jobRole`, `Qualification_level`, `Category`, `Picture`, `brief_profile`) VALUES
(:employee_number,:Title,:first_name,:last_name,:date_of_birth,:email,:mobile_number,:whatsapp,:address1,:address2,:city_town,
:genda,:country,:date_joined,:jobRole,:Qualification_level,:category,:nameofFile,:profile)";
...
$stmt->bindParam(":Qualification_level",$Qualification_level);
									...
									<div class="control-group">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<textarea type="text" rows="10" class="span6 m-wrap"  name="profile"></textarea>
