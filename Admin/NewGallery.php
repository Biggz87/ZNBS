...
$SQL3 = "INSERT INTO `gallery`(`Image_id`, `Name`, `Address`, `Category`, `Status`) 
VALUES ('','$Title','$nameofFile','$category','$status')";
 ...
 echo "<script>window.location = 'GaleryList.php?status=Yes'</script>";
    		
}else {


			
			 echo "<script>window.location = 'GaleryList.php?status=No</script>";
...
?> 
						<!-- BEGIN SAMPLE FORM PORTLET-->   
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>New Gallery Image</div>
