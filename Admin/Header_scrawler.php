							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<a href="NewCarousel.php"><button " class="btn green">
 ...
 $propertySQL="SELECT `itemrid`, `header1`, `header2`, `header_3` FROM `carausel`";
            ...
            ?>
										<tr class="">
											...
											<td><?php  echo $row5['header1']; ?></td>

											

											<td><?php  echo $row5['header2']; ?></td>
											<td><?php  echo $row5['header_3']; ?></td>
											<td></td>
										...
										<ul class="dropdown-menu pull-right">
											...
											<li><a href="EditCarousel.php?itemid=<?php  echo $row5['itemrid']; ?>">Edit Item</a></li>

											<li><a href="DeleteCarousel.php?itemid=<?php  echo $row5['itemrid']; ?>">Delete Item</a></li>
