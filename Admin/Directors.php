...
$status=$_GET['del'];
			if($status=='Yes'){
	echo '<div class="alert alert-success"> The Director has been Deleted</div>';
}elseif($status=='No'){
	echo '<div class="alert alert-danger"> an error coccured The Director has NOT been Deleted </div>';
} ?>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<a href="NewDirector.php"><button " class="btn green">
  ...
  $propertySQL="SELECT * FROM `directors`";
										...
										<tr class="">
											...
											<td><?php echo $row5['Identity'] ?></td>
                                           <td class="hidden-480" ><?php echo  $row5['Title']    ?></td>
											<td class="hidden-480"><?php echo  $row5['Firstname']  ?> <?php echo  $row5['LastName'] ?> </td>

											

											<td class="center hidden-480"><?php echo  $row5['Role']   ?></td>
