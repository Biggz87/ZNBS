            ...
            ?>
						...
						<div id="EditResponsibility" class="modal hide fade" tabindex="-1" data-width="760">
									...
									<div class="modal-footer">
										...
										<button type="button" class="btn blue" onclick="saveResponsibility()">Save changes</button>
...
function NewResponsibility(Responsibiltyid){
	
	
	var Respoinsibilty=document.getElementById("NewResponsibitybox").value;
	// ;
    ...
    $.ajax({
       ...
       data: "vacancyid="+Responsibiltyid+"&Respoinsibilty="+Respoinsibilty,
       success:  function(data)
       {
		   console.log(data);
         if(data.trim()=="success"){
			
			document.getElementById("NewSponsibityFeedback").innerHTML='<div class="alert alert-success"> The Respoinsibilty Saved Successfully</div>';
			
	   }
	   else{
		  document.getElementById("NewSponsibityFeedback").innerHTML='<div class="alert alert-danger"> The  Respoinsibilty not saved</div>'; 
	   }
	   }
