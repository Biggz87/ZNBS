...
?> 
								...
								<form action="#" method="POST" enctype="multipart/form-data" class="form-horizontal">
								  ...
								  <div class="control-group">
										...
										<div class="controls">
											...
											<input type="text"  name="title" class="span6 m-wrap" value="<?php  echo $row5['tittle']; ?>" required />
 ...
 $downloadSQL="SELECT `Categoty_id`, `name` FROM `downlaod_categories`";
		   ...
		   <div class="controls">
    <a href="<?php  echo $row5['address']; ?>" target="_new">View Existing File </a><input type="file" name="Ducument_upload" value="" accept=".pdf" >
						</div>
						</div>
