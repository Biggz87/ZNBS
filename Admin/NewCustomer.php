...
include 'Get_property_id.php';
 ...
 $Location_province=$_POST['Location_province'];
  ...
  $DateSAtarted=date("Y/m/d");
  



 $SQL3 = "INSERT INTO `customer_tbl`(`cif_id`, `first_name`, `last_name`, `email`, `mobile_number`, `address1`, `address2`, `city_town`, `genda`, `date_joined`, `Picture`, `Province`) VALUES
 ('','$first_name','$last_name','$email',' $mobile_number','$address1','$address2','$City','$Gender','$DateSAtarted','','$Location_province')";
  
    $result3= mysqli_query($conn,$SQL3);
   if($result3){
   
  echo '<div class="alert alert-success"> The Property has been added Successfully</div>';
   echo "<script>window.location = 'Customer_list.php?status=Yes'</script>";
    		
}else {


			
			 echo "<script>window.location = 'Customer_list.php?status=No</script>";
								  ...
								  <div class="span4 control-group">
									...
									<input type="text"  name="first_name" class="span6 m-wrap" required />
									 ...
									 <div class="control-group">
										...
										<select  name="Gender" >
																	...
																	<option value="Copper-belt">Female</option>
																	<
																</select>
									...
									<div class="control-group">
                                      ...
                                      <input type="text"  name="address2" class="span6 m-wrap" required />
										...
										<div class="controls">
                                      <input type="text"  name="City" class="span6 m-wrap" required />
